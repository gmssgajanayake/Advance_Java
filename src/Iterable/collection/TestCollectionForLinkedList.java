...
public class TestCollectionForLinkedList {
    public static void main(String[] args) {
        ...
        System.out.println(list1); //[A, S]

        // 12) int	    size()
        System.out.println(list1.size()); // 2

        // 13) Object[]	toArray()
        System.out.println(list1.toArray()[1]); // S

        // 14) <T> T[]	toArray(T[] a)
        String[] array1 = list1.toArray(new String[10]);

        for (String e : array1) {   //  A, S, null, null, null, null, null, null, null, null
            System.out.print(e + ", ");
        }

        System.out.println();

        array1 = list1.toArray(new String[2]);  // A, S
        for (String e : array1) {
            System.out.print(e + ", ");
        }
